...
- 현재 결과물은 Workshop import에서 32,746 / 32,768 elements로 측정됐다. 남은 예산은 22 elements다.
...
- Overwatch Workshop import 성공, 32,746 / 32,768 elements 확인
...
- 변경 후 Workshop element 수는 아직 클라이언트에서 재측정하지 않았다. 마지막 실측 32,746 / 32,768은 변경 전 기준으로 유지한다.
